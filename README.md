...
### Important - The releases contains one more folder (https://github.com/JohannesNE/literature-clock/tree/master/docs/times) which is not uploaded to this repository. So do not download the code from the repo as a zip file. Download the zip file from releases ONLY. <br>
